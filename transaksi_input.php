        ...
        <form action="?page=transaksi_proses" method="post">
   	      <table width="100%" height="80%" align="center" cellspacing="0" cellpadding="5">
   	        <tbody>
                ...
                <tr>
                	<td width="20%" align="right">Nama Peminjam</td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="tgl_pinjam" size="30%" value="<?php echo $pinjam; ?>" ></td>
                </tr>
                <tr>
                	<td width="20%" align="right">Tanggal Kembali</td>
                    <td><input type="text" name="tgl_kembali" size="30%" value="<?php echo $kembali; ?> "</td>
                </tr>
                <tr>
