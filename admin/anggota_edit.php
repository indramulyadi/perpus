   	        ...
   	        <tbody>
                ...
                <tr>
                    ...
                    <td><select name="prodi">
                            ...
                            <option value="S1 Teknik Elektro"  <?php if ($prodi=='S1 TekniknElektro') {echo "selected";} ?>>S1 Teknik Elektro</option>
                            <option value="D3 Teknik  Elektro"  <?php if ($prodi=='S1 Teknik Elektro') {echo "selected";} ?>>S1 Teknik  Elektro</option>
                            <option value="S1 Teknik Mesin"  <?php if ($prodi=='S1 Teknik Mesin') {echo "selected";} ?>>S1 Teknik Mesin</option>
                            <option value="D3 Teknik  Mesin"  <?php if ($prodi=='S1 Teknik Mesin') {echo "selected";} ?>>S1 Teknik Mesin</option>
                            <option value="S1 Teknik Sipil" <?php if ($prodi=='S1 Teknik Sipil') {echo "selected";} ?>>S1 Teknik Sipil</option>
                    	</select>
                    </td>
                </tr>               
                <tr>
